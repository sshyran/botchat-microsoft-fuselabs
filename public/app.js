...
/***/ function(module, exports, __webpack_require__) {
	...
	var Console_tsx_1 = __webpack_require__(351);
	var guid = function () {
	...
	var incoming$ = function (conversation, userId) {
	    return directLine_1.getActivities(conversation)
	        .filter(function (botmessage) { return botmessage.from.id != userId; });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var baseUrl = domain + "/V3/directline/conversations";
	/*
	...
	*/
	...
	exports.getActivities = function (conversation) {
	    return rxjs_1.Observable
	        .webSocket(conversation.streamUrl)
	        .do(function (activity) { return console.log("WS message", activity); });
	};
	/*
	...
	var History = (function (_super) {
	    ...
	    History.prototype.render = function () {
	        ...
	        return (React.createElement("div", {className: "wc-message-groups", ref: function (ref) { return _this.scrollme = ref; }, onScroll: function (e) { return _this.props.actions.setAutoscroll(e.target.scrollTop + e.target.offsetHeight >= e.target.scrollHeight); }}, this.props.messagegroups.map(function (messagegroup) {
	            return React.createElement("div", {className: "wc-message-group"}, React.createElement(Timestamp_tsx_1.Timestamp, {timestamp: messagegroup.ts}), messagegroup.messages.map(function (message) { return React.createElement(HistoryMessage_tsx_1.HistoryMessage, {message: message, actions: _this.props.actions}); }));
	        })));
	    };
	    return History;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var React = __webpack_require__(2);
	var HeroCard_tsx_1 = __webpack_require__(350);
	...
	exports.HistoryMessage = function (props) {
	    ...
	    if (props.message.attachments && props.message.attachments.length > 0) {
	        var attachment = props.message.attachments[0];
	        if (attachment.contentType === "application/vnd.microsoft.card.hero")
	            inside = React.createElement(HeroCard_tsx_1.HeroCard, {actions: props.actions, content: attachment});
	        else if (attachment.contentType === "image/png")
	            inside = React.createElement("img", {src: attachment.contentUrl});
	    }
	    else {
	        inside = React.createElement("span", null, textify(props.message.text));
	    }
	    return (React.createElement("div", {className: 'wc-message wc-message-from-' + (props.message.fromBot ? 'bot' : 'me')}, React.createElement("div", {className: "wc-message-content"}, React.createElement("svg", {className: "wc-message-callout"}, React.createElement("path", {className: "point-left", d: "m0,0 h12 v10 z"}), React.createElement("path", {className: "point-right", d: "m0,10 v-10 h12 z"})), inside), React.createElement("div", {className: "wc-message-from"}, props.message.fromBot ? props.message.from.id : 'you')));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.HeroCard = function (props) {
	    ...
	    return (React.createElement("div", {class: "imageMessage"}, props.content.images.map(function (image) { return React.createElement("img", {src: image.url}); }), React.createElement("p", null, React.createElement("b", null, props.content.title)), React.createElement("p", null, React.createElement("i", null, props.content.subtitle)), React.createElement("p", null, props.content.text), React.createElement("ul", null, props.content.buttons.map(function (button) { return React.createElement("li", null, React.createElement("button", {onClick: function () { return buttonActions[button.type](button.value); }}, button.title)); }))));
	};
